        ...
        body: Container(
          child: ListView(
            children: <Widget>[
              FadeAnimation(1.0,Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage('assets/images/blue-white.jpg'),
                    fit:BoxFit.fill,
                    ),
                          ...
                          child: Align(
                             alignment: Alignment.bottomCenter,
                              ...
                              style: TextStyle(
                                ...
                                color:Color.fromRGBO(11, 108, 173, .6)
              ...
              Padding(
                padding:EdgeInsets.all(deviceHeight*0.035/*30.0*/),
                child: Column(
                  children:<Widget>[
                     FadeAnimation(1.6, Container(
                      padding: EdgeInsets.all(deviceHeight*0.0065/*5.0*/),
                      decoration: BoxDecoration(
                        color: Colors.white, 
                        borderRadius:BorderRadius.circular(deviceHeight*0.017/*10.0*/),
                        boxShadow: [
                          BoxShadow(
                            color: Color.fromRGBO(11, 108, 173, .3),
                            blurRadius: 20.0,
                            offset:Offset(2,10),
                          ),
                        ...
                        child:Column(
                          ...
                          SizedBox(height: deviceHeight*0.0065),
                           ...
                           SizedBox(height: deviceHeight*0.025),
                              FadeAnimation(2.3,Text("Forgot password?",
                                 style: TextStyle(
                              color: Color.fromRGBO(11, 108, 173, .5)
                                 ),
                                 ),),
