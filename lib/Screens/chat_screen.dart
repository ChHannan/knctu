 ...
 _buildMessageComposer(){
   return Container(
     ...
     child: Row(
       children: <Widget>[
         ...
         Expanded(
           child:TextField(
             textCapitalization: TextCapitalization.sentences, // To capitalize the first letter
             onChanged: (value) {},
  ...
  _buildMessage(Message message, bool isMe){
    return Container(
      ...
      padding: EdgeInsets.symmetric(horizontal:_width *0.069,vertical: _height*0.02),
                  ...
                  child: ClipRRect(
                    ...
                    topRight:Radius.circular(_width *0.0553)
                     ...
                     child: ListView.builder(
                       ...
                       reverse: true, //mesages start from the bottom and then rises up
