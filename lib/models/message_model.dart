...
final User currentUser =
    User(id: 0, name: 'Current User', imageUrl: 'assets/images/customer-1.jpg');
//database
// other Users
final User sara =
    User(id: 1, name: 'Sara', imageUrl: 'assets/images/customer-2.jpg');

final User tayyab =
    User(id: 2, name: 'Tayyab', imageUrl: 'assets/images/customer-3.jpg');

final User kenna =
    User(id: 3, name: 'Kenna', imageUrl: 'assets/images/customer-1.jpg');
...
List<Message1> messages = [
  ...
  Message1(
    ...
    time: '3:27 PM',
    text:
        "Sure, I could give you all the information you need on NUST and could"
        " refer you to a friend of mine who could guide you better related to FAST",
    unread: false,
  ),
  Message1(
    sender: currentUser,
    time: '3:00 PM',
    text:
        'Its been alright, I was wondering if you could give me some insight on the pros and cons of CS in FAST and in NUST',
    unread: false,
  ),
  Message1(
    sender: sara,
